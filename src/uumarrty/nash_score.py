...
import os
import time
from uumarrty import point_classification as ipc
...
def main():
    label = 'test_run'
    file_path_parameter = '/home/micha/Documents/run_uumarrty/test_run/Data/test_config.parameters.csv'
    file_path_per_cycle = '/home/micha/Documents/run_uumarrty/test_run/Data/test_config._per_cycle.csv'
    output_csv_file_path = '/home/micha/Documents/run_uumarrty/test_run/Data/{}_nash_analysis.csv'.format(label)
