...
class Cell(object):
	def __init__(self,landscape, habitat_type,krat_energy_cost,snake_energy_cost,krat_energy_gain,strike_success_probability):
		# Order: open, bush
	...
	def pop_snake(self):
		...
		snake_index = self.rng.randint(0,len(self.snakes))
